...
import { getProductDetail, editProduct } from "../services/productServices";
...
function onSubmit(values){
  ...
  editProduct(body, values.id).then((u)=> console.log("Succesfully edited with id: "+u.id)).catch((e)=>console.log(e));
  ...
  return (
    ...
    <div>        
      ...
      <Form>
        ...
        <ButtonFooter type="submit">Save</ButtonFooter>
      </Form>
      )}
      </Formik>
      )}
